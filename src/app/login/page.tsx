            ...
            <div className="card w-96 bg-base-100 shadow-xl border mt-20 mb-20">
                <form className="card-body" onSubmit={onSubmit}>
                    ...
                    <div className="card-actions justify-end">
                        <button className="btn btn-primary w-full" disabled={loading}>{loading ? "Please Wait..." : "Login"}</button>
                    </div>
                    <div className="card-actions justify-end">
                        <Link href={"/signup"} className="btn btn-neutral w-full">Register</Link>
                    </div>
                </form>
